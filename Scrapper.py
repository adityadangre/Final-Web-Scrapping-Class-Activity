...
headers = ['name', 'light_years_from_earth', 'planet_mass', 'stellar_magnitude', 'discovery_date', 'hyperlink', 'planet_type', 'planet_radius', 'orbital_raditus', 'orbital_period', 'eccentricity']
planet_data = []
new_planet_data = []
final_planet_data = []
